...
import algebra.finalwork.inversaatual.InversaAtual;
...
public class InversaController implements Initializable {
	...
	public void calculaTransposta() {
		...
		matriz.setMatriz(InversaAtual.invertMatrix(newMatriz));
